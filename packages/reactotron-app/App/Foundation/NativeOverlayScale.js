    ...
    return (
      <div style={Styles.container}>
        <div style={Styles.row}>
          <button style={makeButtonStyle(0.33)} onClick={makeHandler(0.33)}>1/3</button>
          <button style={makeButtonStyle(0.5)} onClick={makeHandler(0.5)}>1/2</button>
          <button style={makeButtonStyle(1)} onClick={makeHandler(1)}>1</button>
          <button style={makeButtonStyle(2)} onClick={makeHandler(2)}>2</button>
          <button style={makeButtonStyle(3)} onClick={makeHandler(3)}>3</button>
        </div>
      </div>
    )
  }
