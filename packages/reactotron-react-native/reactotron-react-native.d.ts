declare module 'reactotron-react-native' {
  ...
  export interface Reactotron {
      ...
      /**
       * Allows you to have an image uploaded to your simulator to stay on top of your app.
       */
      overlay (view: any): Component<any, any>
      /**
       * Allows you to have an image uploaded to your simulator to stay on top of your app.
       */
  ...
  export const trackGlobalErrors = () => null
  export const openInEditor = () => null
  export const asyncStorage = () => null
  export const networking = () => null
}