...
[Download OS X App](https://github.com/reactotron/reactotron/releases/download/v1.6.0/Reactotron.app.zip) from GitHub release and drop the Reactotron.app to the Applications folder.
